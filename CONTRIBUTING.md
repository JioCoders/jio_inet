# Contributing to Jio Inet

First off, thank you for considering contributing to Jio Inet! Your help is essential for making this project the best it can be.
...
2. **Clone the Repository**
   ...
   ```sh
   git clone https://github.com/jiocoders/jio_inet.git
